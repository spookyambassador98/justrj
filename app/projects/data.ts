...
export const projectsData: Project[] = [
  {
    ...
    features: [
      ...
      {
        id: "form",
        title: { en: "Add a product", ru: "Добавить товар", uk: "Додати товар" },
        body: {
          en: "Paste the marketplace URL, set a floor, leave an email. Watch starts the first scrape immediately.",
          ru: "Вставь ссылку, поставь порог, оставь email. Watch сразу бьёт в парсер.",
          uk: "Встав посилання, постав поріг, залиш email. Watch одразу б'є в парсер.",
        },
        image: shotEn("price-radar", "form-viewport.png"),
        caption: { en: "URL, floor, notify", ru: "Ссылка, порог, уведомление", uk: "Посилання, поріг, сповіщення" },
      },
      {
        id: "board",
        ...
        image: shotEn("price-radar", "board-viewport.png"),
      ...
      {
        id: "chart",
        title: { en: "Tick chart", ru: "График тиков", uk: "Графік тіків" },
        body: {
          en: "Every scrape is a tick. The dashed line is your floor. Check now if you do not want to wait for the hour.",
          ru: "Каждая проверка — тик. Пунктир — твой порог. Check now, если не хочешь ждать час.",
          uk: "Кожна перевірка — тік. Пунктир — твій поріг. Check now, якщо не хочеш чекати годину.",
        },
        image: shotEn("price-radar", "chart-viewport.png"),
        caption: { en: "Floor vs live price", ru: "Порог против живой цены", uk: "Поріг проти живої ціни" },
      },
    ],
    architecture: {
...
watch.add(url) → scrape.price() → alert.ifDropped()`,
  },
  {
    ...
    image: shotEn("middocs", "collab-maya-viewport.png"),
    imageCaption: {
      en: "Two accounts, one doc — Maya and Alex live",
      ru: "Два аккаунта, один документ — Maya и Alex вживую",
      uk: "Два акаунти, один документ — Maya і Alex наживо",
    },
    ...
    result: {
      en: "Created two accounts. Opened the same /doc/:id. Both typed. Avatars, highlights and the paragraph stayed one Y.Doc.",
      ru: "Создал два аккаунта. Открыл один /doc/:id. Оба печатали. Аватары, подсветка и абзац — один Y.Doc.",
      uk: "Створив два акаунти. Відкрив один /doc/:id. Обидва друкували. Аватари, підсвітка і абзац — один Y.Doc.",
    },
    overview: {
      en: [
    ...
    features: [
      {
        ...
        image: shotEn("middocs", "login-viewport.png"),
      ...
      },
      {
        ...
        image: shotEn("middocs", "register-viewport.png"),
        caption: { en: "Register card", ru: "Карточка регистрации", uk: "Картка реєстрації" },
      },
      {
        id: "dashboard",
        title: { en: "Document board", ru: "Доска документов", uk: "Дошка документів" },
        body: {
          en: "New doc, encrypted doc, or open Launch brief. Maya’s dashboard after the shared file exists.",
          ru: "Новый документ, зашифрованный, или открыть Launch brief. Дашборд Maya после общего файла.",
          uk: "Новий документ, зашифрований, або відкрити Launch brief. Дашборд Maya після спільного файлу.",
        },
        image: shotEn("middocs", "dashboard-viewport.png"),
        caption: { en: "My documents", ru: "Мои документы", uk: "Мої документи" },
      },
      {
        id: "editor",
        title: { en: "Live editor", ru: "Живой редактор", uk: "Живий редактор" },
        body: {
          en: "Quill bound to Yjs. Title is shared. Online pill is green when the socket holds.",
          ru: "Quill на Yjs. Заголовок общий. Online зелёный, пока сокет живой.",
          uk: "Quill на Yjs. Заголовок спільний. Online зелений, поки сокет живий.",
        },
        image: shotEn("middocs", "editor-viewport.png"),
        caption: { en: "Launch brief", ru: "Launch brief", uk: "Launch brief" },
      },
      {
        id: "collab-maya",
        title: { en: "Maya’s session", ru: "Сессия Maya", uk: "Сесія Maya" },
        body: {
          en: "Account A. MC in the bar. Alex’s paragraph is already in the file — same room, not a copy.",
          ru: "Аккаунт A. MC в баре. Абзац Alex уже в файле — та же комната, не копия.",
          uk: "Акаунт A. MC у барі. Абзац Alex уже у файлі — та сама кімната, не копія.",
        },
        image: shotEn("middocs", "collab-maya-viewport.png"),
        caption: { en: "Maya Chen · live", ru: "Maya Chen · вживую", uk: "Maya Chen · наживо" },
      },
      {
        id: "collab-alex",
        title: { en: "Alex’s session", ru: "Сессия Alex", uk: "Сесія Alex" },
        body: {
          en: "Account B. AR in the bar. Maya’s highlight and Alex’s highlight on the same Y.Doc.",
          ru: "Аккаунт B. AR в баре. Подсветка Maya и подсветка Alex на одном Y.Doc.",
          uk: "Акаунт B. AR у барі. Підсвітка Maya і підсвітка Alex на одному Y.Doc.",
        },
        image: shotEn("middocs", "collab-alex-viewport.png"),
        caption: { en: "Alex Rivera · live", ru: "Alex Rivera · вживую", uk: "Alex Rivera · наживо" },
      },
      {
        id: "comments",
        title: { en: "Comments", ru: "Комментарии", uk: "Коментарі" },
        body: {
          en: "Select a range, leave a note. The thread rides Yjs relative positions so it does not drift off the sentence.",
          ru: "Выдели фрагмент, оставь заметку. Тред сидит на Yjs relative positions — не съезжает с предложения.",
          uk: "Виділи фрагмент, залиш нотатку. Тред сидить на Yjs relative positions — не з'їжджає з речення.",
        },
        image: shotEn("middocs", "comments-viewport.png"),
        caption: { en: "Comments rail", ru: "Панель комментариев", uk: "Панель коментарів" },
      },
    ],
    architecture: {
...
join(room) → yjs.sync() → persist.toPostgres()`,
  },
  {
    ...
    features: [
      ...
      {
        id: "diagnosis",
        title: { en: "Diagnosis", ru: "Диагноз", uk: "Діагноз" },
        body: {
          en: "The session as a body: what fired, what lagged, what still looks healthy.",
          ru: "Сессия как тело: что стрельнуло, что зависло, что ещё выглядит живым.",
          uk: "Сесія як тіло: що стрільнуло, що зависло, що ще виглядає живим.",
        },
        image: shotEn("pulse", "diagnosis-viewport.png"),
        caption: { en: "Diagnosis cards", ru: "Карточки диагноза", uk: "Картки діагнозу" },
      },
      {
        id: "readout",
        ...
        image: shotEn("pulse", "readout-viewport.png"),
      ...
      },
      {
        ...
        body: {
          en: "Permission first. Then Pulse reads this tab’s own timing — TTFB, requests, connection. Nothing is sent anywhere.",
          ru: "Сначала разрешение. Потом Pulse читает тайминги этой вкладки — TTFB, запросы, сеть. Ничего никуда не уходит.",
          uk: "Спочатку дозвіл. Потім Pulse читає таймінги цієї вкладки — TTFB, запити, мережа. Нічого нікуди не йде.",
        },
        image: shotEn("pulse", "monitor-viewport.png"),
        caption: { en: "Live axon", ru: "Живой аксон", uk: "Живий аксон" },
      },
    ],
    architecture: {
